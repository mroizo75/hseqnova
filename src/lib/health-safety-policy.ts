...
<p>Live records sit in inspections, fire drills and training. There is no separate annual plan module.</p>`,
  },
  {
    ...
    content: `<p>Internal audits check whether the policy and arrangements are followed in practice. Findings become actions. Audit programmes and reports live in Internal audits. The ISO work guide and auditor pack sit under ISO 45001 &amp; 9001.</p>
<p>Certification is granted by a UKAS-accredited body, not by this software.</p>`,
  },
  {
    sectionKey: "s16",
    sectionNumber: "19",
    title: "ISO 45001 and ISO 9001",
    policyPart: "arrangements",
    legalRef: "ISO 45001:2018; ISO 9001:2015 (optional)",
    sortOrder: 19,
    moduleLink: "/dashboard/iso",
    content: `<p>Where this organisation seeks certification, the same health and safety records are the management system. The work guide, clause map and auditor pack live in ISO 45001 &amp; 9001.</p>
<p>Objectives, consultation meetings, the legal register and management of change are linked from that guide.</p>`,
  },
  {
    sectionKey: "s17",
    sectionNumber: "20",
    title: "Objectives",
    policyPart: "arrangements",
    legalRef: "ISO 45001 cl. 6.2; ISO 9001 cl. 6.2",
    sortOrder: 20,
    moduleLink: "/dashboard/goals",
    content: `<p>Measurable OH&amp;S and quality objectives, with an owner and target, are held in Objectives. Progress is reviewed in management review.</p>`,
  },
  {
    sectionKey: "s18",
    sectionNumber: "21",
    title: "Consultation of workers",
    policyPart: "arrangements",
    legalRef: "ISO 45001 cl. 5.4; SRSCWR 1977",
    sortOrder: 21,
    moduleLink: "/dashboard/meetings",
    content: `<p>Consultation meetings, attendance and decisions are recorded as minutes. Safety representatives are named on the organisation chart.</p>`,
  },
  {
    sectionKey: "s19",
    sectionNumber: "22",
    ...
    policyPart: "arrangements",
    legalRef: "ISO 45001 cl. 8.1.3",
    sortOrder: 22,
    moduleLink: "/dashboard/changes",
    content: `<p>Planned changes to plant, process or organisation are assessed for health and safety, training and document impact before they go live. Records live in Management of change.</p>`,
  },
  {
    sectionKey: "s20",
    sectionNumber: "23",
    ...
    policyPart: "arrangements",
    legalRef: "ISO 45001 cl. 6.1.3 and 9.1.2",
    sortOrder: 23,
    moduleLink: "/dashboard/legal-register",
    content: `<p>The legal register lists the duties that apply to this undertaking. Compliance is evaluated at planned intervals. Results feed management review.</p>`,
  },
  {
    sectionKey: "s15",
    sectionNumber: "18",
...
const POLICY_MODULE_LINK_KEYS: Record<string, string> = {
  ...
  "/dashboard/iso": "iso",
  "/dashboard/goals": "iso",
  "/dashboard/meetings": "iso",
  "/dashboard/changes": "iso",
  "/dashboard/legal-register": "iso",
