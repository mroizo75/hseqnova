...
export const HOME_FAQS = [
  ...
  },
  {
    ...
    answer:
      `Self-serve checkout is card or Bacs Direct Debit, monthly or yearly. Invoice (Net 30) is available if you email ${SITE_CONFIG.contactEmail}. Prices are in GBP excluding VAT.`,
  },
  {
