...
export const createIncidentSchema = z.object({
  ...
  description: z.string().min(5, "Describe what happened"),
  ...
  injuredPersonOccupation: z.string().max(120).optional(),
  injuredPersonAddress: z.string().max(300).optional(),
  injuredPersonRole: z.enum(["employee", "contractor", "visitor", "member_of_public"]).optional(),
  witnessAddress: z.string().max(300).optional(),
  shareWithSafetyRepsConsent: z.boolean().optional(),
  reporterAcknowledged: z.boolean().optional(),
  specifiedInjury: z.boolean().optional(),
  listedOccupationalDisease: z.boolean().optional(),
  listedDangerousOccurrence: z.boolean().optional(),
  nonWorkerTakenToHospital: z.boolean().optional(),
  overThreeDayInjury: z.boolean().optional(),
  riddorReportMethod: z.enum(["phone", "online"]).optional(),
...
export const updateIncidentSchema = z.object({
  ...
  injuredPersonOccupation: z.string().max(120).optional(),
  injuredPersonAddress: z.string().max(300).optional(),
  injuredPersonRole: z.enum(["employee", "contractor", "visitor", "member_of_public"]).optional().nullable(),
  witnessAddress: z.string().max(300).optional(),
  shareWithSafetyRepsConsent: z.boolean().optional(),
  reporterAcknowledged: z.boolean().optional(),
  specifiedInjury: z.boolean().optional(),
  ...
  nonWorkerTakenToHospital: z.boolean().optional(),
  overThreeDayInjury: z.boolean().optional(),
  riddorReportMethod: z.enum(["phone", "online"]).optional().nullable(),
  isFatal: z.boolean().optional(),
  isLostTimeIncident: z.boolean().optional(),
  lostWorkdays: z.number().int().min(0).optional(),
  isRestrictedWork: z.boolean().optional(),
...
export function getRiddorCategoryLabel(category: string | null | undefined): string {
  const labels: Record<string, string> = {
    ...
    non_worker: "Non-worker taken to hospital — report within 10 days",
  };
