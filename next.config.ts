...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      { source: "/dashboard/whistleblowing", destination: "/dashboard/health-safety-policy", permanent: false },
      { source: "/dashboard/whistleblowing/:path*", destination: "/dashboard/health-safety-policy", permanent: false },
      ...
      { source: "/ansatt/varsling", destination: "/ansatt", permanent: false },
